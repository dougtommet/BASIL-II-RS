...
```{r}
#| label: fig-demseverity-heatmap-pre-highlighting
#| fig-cap: "Heatmap showing agreement of paired initial ratings of dementia severity (with highlighting)"
...
```{r}
#| label: fig-demseverity-scatter-pre
#| fig-cap: "Scatterplot showing agreement of paired initial ratings of dementia severity"

a1 %>%
  filter(!is.na(dementia_severity_A), !is.na(dementia_severity_B)) %>%
  haven::zap_labels() %>%
  ggplot(aes(x = dementia_severity_A, y = dementia_severity_B)) +
    geom_abline(slope = -1, intercept = 0, color = "blue") +
    geom_jitter(alpha=.5) + 
    scale_x_continuous("Dementia Severity (Rater A)", breaks = 0:4, minor_breaks = NULL,
                       labels = c("No dementia", "Very mild", "Mild", "Moderate", "Severe")) +
...
```{r}
#| label: fig-demseverity-heatmap-post-highlighting
#| fig-cap: "Heatmap showing agreement of paired ratings of dementia severity after consensus process (with highlighting)"
...
```{r}
#| label: fig-demseverity-scatter-post
#| fig-cap: "Scatterplot showing agreement of paired consensus ratings of dementia severity"
