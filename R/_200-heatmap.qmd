...
p_initial <- foo %>%
  ...
  ggplot(aes(x = delirium_severity_A, y = delirium_severity_B, size = n, color = n)) +
    geom_abline(slope = 1, intercept = 0, color = "red") +
    geom_point() + 
    scale_x_continuous("Delirium Severity: Rater A (n = 954)", breaks = 0:9, minor_breaks = NULL, 
                       labels = paste(c("**0** <br> (313)", "**1** <br> (115)", "**2** <br> (76)", "**3** <br> (59)", 
                                        "**4** <br> (80)", "**5** <br> (115)", "**6** <br> (82)", "**7** <br> (62)", 
                                        "**8** <br> (23)", "**9** <br> (29)")) ) +
    scale_y_continuous("Delirium Severity: Rater B (n = 954)", breaks = 0:9, minor_breaks = NULL,
